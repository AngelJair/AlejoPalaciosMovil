...
export default function ConsultaXCategoria({ navigation }) {
  ...
  const leeRegistros = async () => {
    const respuestaPOST = await fetch('http://'+ip+':3000/ConsultaProductosXCat', {
        method: 'POST',
        headers: {
    ...
    <View>
      ...
      <DataTable>
        ...
        <DataTable.Header style={styles.header} textStyle={styles.textheader}>
          ...
          <DataTable.Title textStyle={styles.textheader}></DataTable.Title>
        </DataTable.Header>
